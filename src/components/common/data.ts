export const intro = {
  ...
  experience: [
    { type: "Frontend experience", years: "6 years" },
  ],
  social: [
  ...
  photo:
    "https://media.licdn.com/dms/image/C5603AQFIlU2oV2JEgg/profile-displayphoto-shrink_400_400/0/1638502874210?e=1684368000&v=beta&t=jZhXQa7ZFRrkrje35IydaK8mzrb7RMXk69konSRBFUc",
  about: {
    title: "About me",
...
export const skills = {
  ...
  exposure: {
    ...
    items: [
      ...
      "(e-commerce) CMS systems (e.g. Magento2)",
      ""
    ],
  },
  methodology: {
  ...
  tools: {
    title: "Tools",
    items: ["Git", "VS Code/JetBrains", "Jira/Azure", "NPM/Composer/Yarn/Gulp", "Adobe suite/Figma design tools", "Gitlab/Github/Bitbucket", "Terminal environment/VIM", "Familair with deployments (manual SSH or CI/CD)"],
  },
};
  ...
  companies: [
    {
      ...
      expYears: "5 years",
      description: [
       "I started as an intern and stayed on as a full-time employee at a company where we built custom Magento 2 shops for clients of all sizes and industries. We worked in a Scrum-style team with a designer and back-end developer, where my task was to replicate designs to working shops with (p)HTML, SCSS, jQuery, KnockoutJS, and PHP when needed. Some of the recent shops that I helped deliver include https://www.qhp.nl/?_, https://www.vedder-vedder.com/, https://webshop.alcomex.nl/, and many more."
      ],
    },
    {
